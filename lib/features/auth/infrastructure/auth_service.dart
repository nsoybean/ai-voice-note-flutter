...
class AuthService {
  ...
  Future<AuthUser?> signInWithGoogle() async {
    ...
    // pass code to api server in exchange for jwt and profile data
    final res = await http.post(
      Uri.parse('http://127.0.0.1:3000/auth/sign-in-google'),
      headers: {'Content-Type': 'application/x-www-form-urlencoded'},
      body: {'code': code},
    );

    final signInData = jsonDecode(res.body);

    return AuthUser.fromApiResponse(signInData);
  }
}
